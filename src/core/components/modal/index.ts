...
class ModalItem extends Component {
  ...
  build() {
    ...
    templatePersonData += `<div class="person-name form-item"><input type="text" 
        placeholder="Name" formcontrolname="personName" class="inp-name"></div>`;
    templatePersonData += ` <div class="phone-name form-item"><input type="text" 
        placeholder="Phone number" formcontrolname="phoneNumber" class="inp-phone-num"></div>`;
    templatePersonData += `<div class="adress form-item"><input  type="text" 
        placeholder="Delivery address" formcontrolname="adress" class="inp-adress"></div>`;
    templatePersonData += `<div class="email form-item"><input type="text" 
        placeholder="E-mail" formcontrolname="email" class="inp-email"></div>`;
    templateCartData += `<h2 class="modal-title-cart">Credit card details</h2>`;
    templateCartData += `<div  class="card-data">
        <div  class="number">
          <img  alt="credit-logo" src="https://i.guim.co.uk/img/media/b73cc57cb1d46ae742efd06b6c58805e8600d482/16_0_2443_1466/master/2443.jpg?width=700&amp;quality=85&amp;auto=format&amp;fit=max&amp;s=fb1dca6cdd4589cd9ef2fc941935de71">
          <input  type="text" formcontrolname="cardNumber" placeholder="Card number" class="cart-number">
        </div>
          <div  class="other-data">
            <div class="valid-data"> VALID: 
            <input  type="text" formcontrolname="cardDate" placeholder="Valid Thru" class="caet-date"></div>
